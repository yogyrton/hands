...
class Visit extends Model
{
    ...
    /**
     * Сумма оказанных услуг за период (Σ итоговых цен) — то, что «заработала»
     * студия, независимо от способа оплаты (в т.ч. визиты по сертификатам).
     * База для расчёта прибыли: услуга по сертификату — тоже заработок, просто
     * деньги пришли раньше при продаже сертификата.
     */
    public static function servicesTotal(\DateTimeInterface $from, \DateTimeInterface $until): float
    {

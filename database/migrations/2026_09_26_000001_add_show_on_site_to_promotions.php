...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $loyalty = [
            [
                'slug' => 'loyal-15',
                'title' => 'Постоянный клиент −15%',
                'description' => 'Скидка 15% постоянному клиенту (например, с 5-го массажа).',
                'discount_percent' => 15,
                'sort_order' => 90,
            ],
            [
                'slug' => 'loyal-50',
                'title' => 'Постоянный клиент −50%',
                'description' => 'Скидка 50% постоянному клиенту (например, с 10-го массажа).',
                'discount_percent' => 50,
                'sort_order' => 91,
            ],
        ];
